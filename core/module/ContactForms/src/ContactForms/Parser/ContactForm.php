...
class ContactForm implements ServiceManagerAwareInterface
{
    ...
    public function setFormEntity(\ContactForms\Entity\ContactForm $contactFormEntity)
    {
    ...
    {
        $formData = $this->contactFormEntity->getData();
        ...
        $template = $this->do_shortcode($template);
