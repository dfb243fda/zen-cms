...
class NewsFormFactory implements ServiceManagerAwareInterface
{
    ...
    public function getForm()
    {
        ...
        if (null === $objectTypeId) {
            if (null === $this->objectId) {
                $objectTypeId = $objectTypesCollection->getTypeIdByGuid($newsService->getNewsGuid());  
            } else {
