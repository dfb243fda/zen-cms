...
namespace Rbac\Guard;

use Rbac\Provider\Rule\ProviderInterface as RuleProviderInterface;
use Rbac\Provider\Resource\ProviderInterface as ResourceProviderInterface;
...
class Controller implements GuardInterface, RuleProviderInterface, ResourceProviderInterface
{
    ...
    public function onDispatch(MvcEvent $event)
    {
        ...
        $service    = $this->serviceLocator->get('Rbac\Service\Authorize');
