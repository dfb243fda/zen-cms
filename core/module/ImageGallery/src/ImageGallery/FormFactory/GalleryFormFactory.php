...
namespace ImageGallery\FormFactory;

use Zend\ServiceManager\ServiceManagerAwareInterface;
use Zend\ServiceManager\ServiceManager;

class GalleryFormFactory implements ServiceManagerAwareInterface
{
    ...
    public function getForm()
    {
        ...
        $galService = $this->serviceManager->get('ImageGallery\Service\ImageGallery');
        
        $baseForm = $this->serviceManager->get('FormElementManager')
                                     ->get('ImageGallery\Form\BaseGalleryForm');  
        ...
        if (null === $objectTypeId) {
            if (null === $this->objectId) {
                $objectTypeId = $objectTypesCollection->getTypeIdByGuid($galService->getGalleryGuid());  
            } else {
