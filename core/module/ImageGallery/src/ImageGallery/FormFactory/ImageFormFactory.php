...
class ImageFormFactory implements ServiceManagerAwareInterface
{
    ...
    public function getForm()
    {
        ...
        $imgService = $this->serviceManager->get('ImageGallery\Service\ImageGallery');
        
        $baseForm = $this->serviceManager->get('FormElementManager')
                                     ->get('ImageGallery\Form\BaseImageForm');  
        ...
        if (null === $objectTypeId) {
            if (null === $this->objectId) {
                $objectTypeId = $objectTypesCollection->getTypeIdByGuid($imgService->getImageGuid());  
            } else {
