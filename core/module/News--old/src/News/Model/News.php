...
class News
{
    ...
    protected $rubricGuid = 'news-category';
    protected $itemGuid   = 'news-item';
    ...
    {        
        ...
        if (null === $this->objectId) {      
            ...
            if (self::ITEM == $this->newsType && $this->moduleManager->isModuleActive('Comments')) {
    ...
    public function edit($data)
    {
        ...
        foreach ($data as $k=>$v) {
            if (isset($v['name']) && '' == $v['name']) {
                $data[$k]['name'] = $this->translator->translate('News:(Without name)');
            }
        }
