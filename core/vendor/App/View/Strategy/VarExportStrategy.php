...
use App\View\Renderer\VarExportRenderer;
use Zend\View\ViewEvent;
use App\View\Model\VarExportModel;

class VarExportStrategy extends AbstractListenerAggregate
{
    /**
     ...
     */
    public function __construct(VarExportRenderer $renderer)
    {
    ...
    public function selectRenderer(ViewEvent $e)
    {
        ...
        if (!$model instanceof VarExportModel) {
            // no VarExportModel; do nothing
            return;
        }
        
        // VarExportModel found
