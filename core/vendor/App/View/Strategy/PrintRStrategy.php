...
use App\View\Renderer\PrintRRenderer;
use Zend\View\ViewEvent;
use App\View\Model\PrintRModel;

class PrintRStrategy extends AbstractListenerAggregate
{
    /**
     ...
     */
    public function __construct(PrintRRenderer $renderer)
    {
    ...
    public function selectRenderer(ViewEvent $e)
    {
        ...
        if (!$model instanceof PrintRModel) {
            // no PrintRModel; do nothing
            return;
        }
